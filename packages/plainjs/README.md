...
```html
<script type="module">
  import { Parser } from 'https://cdn.jsdelivr.net/gh/juanjoDiaz/json2csv@7.0.8/dist/cdn/plainjs/index.js';
  import { StreamParser } from 'https://cdn.jsdelivr.net/gh/juanjoDiaz/json2csv@7.0.8/dist/cdn/plainjs/index.js';
</script>
```
