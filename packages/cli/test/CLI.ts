...
export default function (
  ...
  testRunner.add(
    'should error on invalid input file path without streaming',
    async (t) => {
  ...
  testRunner.add(
    'should handle deep JSON objects without streaming',
    async (t) => {
      const opts = '--no-streaming';
  ...
  testRunner.add(
    'should error on invalid fields config file path',
    async (t) => {
  ...
  testRunner.add(
    'should get input from stdin and process as stream',
    async (t) => {
  ...
  testRunner.add(
    'should error if stdin data is not valid with -s flag',
    async (t) => {
      const execution = execAsync(`${cli} -s`);
  ...
  testRunner.add(
    'should error on invalid output file path without streaming',
    async (t) => {
      const outputPath = getFixturePath('/results2/default.csv');
      const opts = `-o "${outputPath}" --fields carModel,price,color,manual --no-streaming`;
  ...
  testRunner.add(
    'should print pretty table without streaming and without header',
    async (t) => {
      const opts =
