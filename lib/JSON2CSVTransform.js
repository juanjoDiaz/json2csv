...
class JSON2CSVTransform extends Transform {
  constructor(opts, transformOpts = {}, asyncOptions = {}) {
    ...
    this.endUnderlayingParser = JSON2CSVNewAsyncParser.prototype.end;
    ...
    this.onHeader = (header) => this.emit('header', header);
    this.onLine = (line) => this.emit('line', line);
    this.onData = (data) => this.push(data);
